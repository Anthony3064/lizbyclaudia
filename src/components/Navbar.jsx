        ...
        <nav className="nav">
            ...
            <ul className={`nav__menu ${!showBars ? 'active' : ''}`}>
                ...
                <li className={`nav__item ${linkActive === menuLinks.SERVICES && 'active'}`} >
                    <Link className='nav__link' to='/lizbyclaudia' onClick={() => handleClickLinkActive(menuLinks.SERVICES)}>Servicios</Link>
                </li>
                <li className={`nav__item ${linkActive === menuLinks.CONTACT && 'active'}`} >
                    <Link className='nav__link' to='/lizbyclaudia' onClick={() => handleClickLinkActive(menuLinks.CONTACT)}>Contacto</Link>
                </li>
